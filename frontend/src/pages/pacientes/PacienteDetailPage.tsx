...
function IcoCheck()    { return <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden><path d="M2.5 7l3 3L11 4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg> }
function IcoStar()     { return <svg width="13" height="13" viewBox="0 0 13 13" fill="none" aria-hidden><path d="M6.5 1.5l1.4 2.8 3.1.45-2.25 2.2.53 3.1-2.78-1.46-2.78 1.46.53-3.1L2.0 4.75l3.1-.45L6.5 1.5z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round"/></svg> }
